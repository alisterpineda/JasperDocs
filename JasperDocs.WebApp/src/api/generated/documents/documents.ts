...
export const getApiDocumentsIdParties = (
    id: string,
 signal?: AbortSignal
) => {
      
      
      return customAxiosInstance<DocumentPartyDto[]>(
      {url: `/api/Documents/${id}/parties`, method: 'GET', signal
    },
      );
    }
...
export const getGetApiDocumentsIdPartiesQueryKey = (id?: string,) => {
    return [
    `/api/Documents/${id}/parties`
    ] as const;
    }

    
export const getGetApiDocumentsIdPartiesQueryOptions = <TData = Awaited<ReturnType<typeof getApiDocumentsIdParties>>, TError = ProblemDetails>(id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiDocumentsIdParties>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetApiDocumentsIdPartiesQueryKey(id);

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiDocumentsIdParties>>> = ({ signal }) => getApiDocumentsIdParties(id, signal);

      

      

   return  { queryKey, queryFn, enabled: !!(id), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiDocumentsIdParties>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetApiDocumentsIdPartiesQueryResult = NonNullable<Awaited<ReturnType<typeof getApiDocumentsIdParties>>>
export type GetApiDocumentsIdPartiesQueryError = ProblemDetails


export function useGetApiDocumentsIdParties<TData = Awaited<ReturnType<typeof getApiDocumentsIdParties>>, TError = ProblemDetails>(
 id: string, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiDocumentsIdParties>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof getApiDocumentsIdParties>>,
          TError,
          Awaited<ReturnType<typeof getApiDocumentsIdParties>>
        > , 'initialData'
      >, }
...
export function useGetApiDocumentsIdParties<TData = Awaited<ReturnType<typeof getApiDocumentsIdParties>>, TError = ProblemDetails>(
 id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiDocumentsIdParties>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useGetApiDocumentsIdParties<TData = Awaited<ReturnType<typeof getApiDocumentsIdParties>>, TError = ProblemDetails>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getGetApiDocumentsIdPartiesQueryOptions(id,options)
...
export const postApiDocumentsIdParties = (
    id: string,
    addPartyToDocumentRequest: AddPartyToDocumentRequest,
 signal?: AbortSignal
) => {
      
      
      return customAxiosInstance<void>(
      {url: `/api/Documents/${id}/parties`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: addPartyToDocumentRequest, signal
    },
      );
    }
...
export const getPostApiDocumentsIdPartiesMutationOptions = <TError = ProblemDetails,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiDocumentsIdParties>>, TError,{id: string;data: AddPartyToDocumentRequest}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof postApiDocumentsIdParties>>, TError,{id: string;data: AddPartyToDocumentRequest}, TContext> => {

const mutationKey = ['postApiDocumentsIdParties'];
const {mutation: mutationOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postApiDocumentsIdParties>>, {id: string;data: AddPartyToDocumentRequest}> = (props) => {
          const {id,data} = props ?? {};

          return  postApiDocumentsIdParties(id,data,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiDocumentsIdPartiesMutationResult = NonNullable<Awaited<ReturnType<typeof postApiDocumentsIdParties>>>
    export type PostApiDocumentsIdPartiesMutationBody = AddPartyToDocumentRequest
    export type PostApiDocumentsIdPartiesMutationError = ProblemDetails

    export const usePostApiDocumentsIdParties = <TError = ProblemDetails,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiDocumentsIdParties>>, TError,{id: string;data: AddPartyToDocumentRequest}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof postApiDocumentsIdParties>>,
        TError,
        {id: string;data: AddPartyToDocumentRequest},
        TContext
      > => {

      const mutationOptions = getPostApiDocumentsIdPartiesMutationOptions(options);

      return useMutation(mutationOptions, queryClient);
    }
    export const deleteApiDocumentsIdPartiesPartyId = (
    id: string,
    partyId: string,
 ) => {
      ...
      return customAxiosInstance<void>(
      {url: `/api/Documents/${id}/parties/${partyId}`, method: 'DELETE'
    },
      );
    }
...
export const getDeleteApiDocumentsIdPartiesPartyIdMutationOptions = <TError = ProblemDetails,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteApiDocumentsIdPartiesPartyId>>, TError,{id: string;partyId: string}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof deleteApiDocumentsIdPartiesPartyId>>, TError,{id: string;partyId: string}, TContext> => {

const mutationKey = ['deleteApiDocumentsIdPartiesPartyId'];
const {mutation: mutationOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteApiDocumentsIdPartiesPartyId>>, {id: string;partyId: string}> = (props) => {
          const {id,partyId} = props ?? {};

          return  deleteApiDocumentsIdPartiesPartyId(id,partyId,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteApiDocumentsIdPartiesPartyIdMutationResult = NonNullable<Awaited<ReturnType<typeof deleteApiDocumentsIdPartiesPartyId>>>
    
    export type DeleteApiDocumentsIdPartiesPartyIdMutationError = ProblemDetails

    export const useDeleteApiDocumentsIdPartiesPartyId = <TError = ProblemDetails,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteApiDocumentsIdPartiesPartyId>>, TError,{id: string;partyId: string}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof deleteApiDocumentsIdPartiesPartyId>>,
        TError,
        {id: string;partyId: string},
        TContext
      > => {

      const mutationOptions = getDeleteApiDocumentsIdPartiesPartyIdMutationOptions(options);
