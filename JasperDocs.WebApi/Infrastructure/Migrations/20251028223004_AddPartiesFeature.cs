...
{
    /// <inheritdoc />
    public partial class AddPartiesFeature : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentParties", x => new { x.DocumentId, x.PartyId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_DocumentParties_Parties_PartyId",
                        column: x => x.PartyId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentParties_PartyId",
